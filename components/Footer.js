  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          variants={fadeInUp}
          className="flex flex-col lg:flex-row items-center lg:pr-[95px]
         lg:gap-x-[95px] gap-y-10 lg:gap-y-0"
        >
          ...
          <form
           ...
           lg:order-2 flex flex-col px-[35px] lg:px-[75px] py-[25px] lg:py-[52px]
        ...
        >
          ...
          <ul className="flex  flex-col items-center lg:flex-row gap-y-4  lg:gap-y-0 gap-x-[100px] text-center">
            {links.map((item, idx) => {
              return (
                <li
                  className="text-white font-light hover:text-accent transitions"
                  key={idx}
                >
